  ...
  ga('send', 'pageview');
	...
	<div class="container-fluid" >
		<div class="row-fluid" style="margin-top:4%;" >
				...
				This Privacy Policy governs the manner in which riklr collects, uses, maintains and discloses
information collected from users (each, a "User") of the www.riklr.com website ("Site"). This
privacy policy applies to the Site and all products and services offered by riklr.
				<br>
				<br>
...
services, features or resources we make available on our Site. We will collect personal identification
...
choose to set their web browser to refuse cookies, or to alert you when cookies are being sent. If they
do so, note that some parts of the Site may not function properly.
				<br>
				<br>
				How we use collected information
				<br>
				riklr may collect and use Users personal information for the following purposes:
				<br>
				<br>
				&mdash; To personalize user experience
				<br>
				We may use information in the aggregate to understand how our Users as a group use the services and resources provided on our Site.
				</br>
				&mdash; To send periodic emails
				<br>
...
purposes outlined above.
				...
				<br>
				riklr has the discretion to update this privacy policy at any time. When we do, we will revise the
...
changes to this policy will be deemed your acceptance of those changes.
				...
				site, please contact us at: contactus@riklr.com
				<br>
				riklr
				<br>
				www.riklr.com
				<br>
				<br>
				This document was last updated on April 07, 2013
