...
?>
	...
	<script src="js/refresh_post.js"></script>
	
	<script src="js/refresh_tags.js"></script>
...
<!--------------------------------------post Confession ends------------------------------>
			...
			<div class="span3 "  style = " padding-right: 1.5%; padding-top:60px;  " >
				<div class="well sidebar-nav " style = "box-shadow: 0px 0px 10px #171717; " >
					<div class="row-fluid"  >
						<div class="span3 "  >	
							<a href="http://localhost/Secretags/test/profile/<?=$user_id?>">
								<img src="<?=$photo?>">		
							</a>
						</div>
				
						<div class="span9 "  >				
							<a href="http://localhost/Secretags/test/profile/<?=$user_id?>"><strong><?=$name?>&nbsp;</strong></a>
							<p class="muted"><a href="http://localhost/Secretags/test/profile/<?=$user_id?>" class="muted">View profile</a></p>
						</div>
					</div>
