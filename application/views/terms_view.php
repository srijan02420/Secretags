		...
		<div class="row-fluid" style="margin-top:4%;" >
				...
				<ol type='a'>
					<li>
						...
						software) on riklr's web site for personal, non-commercial transitory viewing only. This is the
						grant of a license, not a transfer of title, and under this license you may not:
						<ol type='i'>
							<li>modify or copy the materials;</li>
							<li>use the materials for any commercial purpose, or for any public display (commercial or non-commercial);</li>
							<li>attempt to decompile or reverse engineer any software contained on riklr's web site;</li>
					...
					<li>
						...
						terminated by riklr at any time. Upon terminating your viewing of these materials or upon the
				...
				<ol type='a'>
					<li>
						The materials on riklr's web site are provided "as is". riklr makes no warranties,
						expressed or implied, and hereby disclaims and negates all other warranties, including without
						limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-
						infringement of intellectual property or other violation of rights. Further, riklr does not warrant
						or make any representations concerning the accuracy, likely results, or reliability of the use of the
						materials on its Internet web site or otherwise relating to such materials or on any sites linked to this
						site.
					</li>
				</ol>
				<h3>
				4. Limitations
					...
					<p>
						In no event shall riklr or its suppliers be liable for any damages (including, without limitation,
						damages for loss of data or profit, or due to business interruption,) arising out of the use or inability
						to use the materials on riklr's Internet site, even if riklr or a riklr authorized
				...
				5. Revisions and Errata
					...
					<p>
						The materials appearing on riklr's web site could include technical, typographical, or
						photographic errors. riklr does not warrant that any of the materials on its web site are
						accurate, complete, or current. riklr may make changes to the materials contained on its web
						site at any time without notice. riklr does not, however, make any commitment to update the
						materials.
					</p>
				<h3>
				6. Links
					...
					<p>
						riklr has not reviewed all of the sites linked to its Internet web site and is not responsible for the
						contents of any such linked site. The inclusion of any link does not imply endorsement by riklr
				...
				7. Site Terms of Use Modifications
					...
					<p>
						riklr may revise these terms of use for its web site at any time without notice. By using this web
				...
				8. Governing Law
					...
					<p>
						Any claim relating to riklr's web site shall be governed by the laws of the State of New Delhi
