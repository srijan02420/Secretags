				...
				function taglongPoll(tag_id,user_id,first)
				{
					if(first==1)
						$( "#loading" ).show();
					
					$.get("http://secretags.com/json/json_get_tag_posts.php", 
					//async = true,
					{ user_id : user_id, first:first,tag_id:tag_id })
					.done(function(data)
					{
						$( "#loading" ).hide();
