				...
				function longPoll(user_id,first,all)
				{
					...
					$.get("http://riklr.com/json/json_get_conff.php", 
					//async = true,
						...
						for(var a=conffs.conff.length-1;a>=0;a--)
							{
								...
								for(i=0;i<conf.comment.length;i++)
									...
									if(conf.special_type==1)
										special = '<strong style = "font-size:18px; margin-right: 10px;"><a href="http://riklr.com/test/profile/'+conf.special_id+'" style = "color:#002E5C;">'+conf.special_name+'</a> commented on a post</strong></br>';
									else if(conf.special_type==2)
										special = '<strong style = "font-size:18px; margin-right: 10px;"><a href="http://riklr.com/test/profile/'+conf.special_id+'" style = "color:#002E5C;">'+conf.special_name+'</a> liked a post</strong></br>';
										 		varhtml =
												special+
