	...
	$.fn.scrollPagination = function(options) {
		...
		return this.each(function() {		
			...
			function getData() {
				...
				$.post('http://riklr.com/json/json_get_recent_conff.php', {
						...
						for(var a=0;a<conffs.conff.length;a++)
							{
								...
								for(i=0;i<conf.comment.length;i++)
									...
									if(conf.commenter.length != 0)
										...
										special = '<strong style = "font-size:18px; margin-right: 10px;"><a href="http://riklr.com/home/profile/'+conf.commenter[0].user_id+'" style = "color:#002E5C;">'+conf.commenter[0].name+'</a> commented on a post</strong></br>';
										}
									else {
										if(conf.liker.length != 0)
											{
											special = '<strong style = "font-size:18px; margin-right: 10px;"><a href="http://riklr.com/home/profile/'+conf.liker[0].user_id+'" style = "color:#002E5C;">'+conf.liker[0].name+'</a> liked a post</strong></br>';
											}
										 }
