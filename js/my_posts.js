	// Main Long Poll function
				function myposts(user_id)
				{
					//alert(user_id);
					// Open an AJAX call to the server's Long Poll PHP file
					
					$.get("http://secretags.com/json/json_get_myposts.php", 
					//async = true,
					{ user_id : user_id})
					.done(function(data)
					{
						...
						if(conffs.success == 1)
						{
							...
							for(var a=conffs.conff.length-1;a>=0;a--)
							{
								...
								for(i=0;i<conf.comment.length;i++)
																	...
																	'<div class="row-fluid">'+
																		...
																		'<div class="span11 ">'+	
																			'<li ><a href="'+link+'"><strong>'+comm.user_name+'&nbsp </a></strong><div class="trim">'+comm.comment+'</div></li>'+
																				'<ul class="inline">'+
																					'<li class="text-info"><a onClick="like_comment('+comm.comment_id+','+conf.conff_id+',this); return false;"></a>&nbsp&nbsp<i class="icon-star"></i><span class="noofcommentlikes'+comm.comment_id+'">'+comm.total_likes+'<span></li>'+
									...
									varhtml =
									'<a class="pull-left" href="#" style = "margin-left:10px; margin-top:10px; background:white; border-radius:4px; box-shadow: 0px 0px 10px #000000;"><img src="http://secretags.com/images/mask2.jpg" class="media-object" width = "84px" style = " border-radius:4px;"></a>'+
								...
								'<ul class="media inline" style = "margin: 8px; ">'+
												...
												'<div class="media-body">'+
																	'<div class="row-fluid"  >'+
																		...
																		'<div  style =" background: #DCDCE8; width:100%; padding-top:0px; border-radius : 0px;">'+
																			...
																			'<textarea rows="1" style = "width:100%; resize:none; border-radius : 0px;  margin : 0 auto; " placeholder="Comment here..." id="comment'+conf.conff_id+'" class="comment_box"></textarea>'+
																				'<div class="navbar comment_rest" style = "margin : 0 auto;">'+
																					'<div class="navbar-inner">'+
																						'<div class="container" >'+
																							...
																							'<ul class="nav pull-right">'+
																								'<i class="icon-user"></i>'+
																								'<select id="gender'+conf.conff_id+'" value="Gender" class="selectpicker" placeholder="Comment As">'+
									...
									'</ul>';						
										...
										$('#your_posts').append('<li class="media" id="conff'+conf.conff_id+'">'+varhtml+'</li>');
